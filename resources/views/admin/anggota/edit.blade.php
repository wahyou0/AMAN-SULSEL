    ...
    <div class="row">
        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <form action="{{ url('anggota/update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_komunitas" value="{{ $data->nama_komunitas }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputEmail2" name="email" value="{{ $data->email }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                    </div>
