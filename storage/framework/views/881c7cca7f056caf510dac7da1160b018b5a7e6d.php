                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="<?php echo e(url('kegiatan_aman/delete/'.$data->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <a class="btn btn-outline-success btn-icon mb-2 me-2 bs-popover rounded" href="<?php echo e(url('kegiatan_aman/edit/'.$data->id)); ?>" data-bs-container="body" data-bs-placement="top" data-bs-trigger="hover" data-bs-content="Edit">
