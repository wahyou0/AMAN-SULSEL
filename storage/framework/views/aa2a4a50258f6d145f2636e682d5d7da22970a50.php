                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="<?php echo e(url('kader_aman/delete/'.$data->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                                <a class="btn btn-outline-success btn-icon mb-2 me-2" href="<?php echo e(url('kader_aman/view/'.$data->id)); ?>">
                                                    <i data-feather="eye"></i>
                                                </a>

                                                <a class="btn btn-outline-success btn-icon mb-2 me-2" href="<?php echo e(url('kader_aman/edit/'.$data->id)); ?>">
